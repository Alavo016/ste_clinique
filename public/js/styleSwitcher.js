...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'dark'){
			...
			jQuery(".nav-header .logo-compact").attr("src", "https://eres.dexignzone.com/xhtml/page-error-404.html");
			jQuery(".nav-header .brand-title").attr("src", "https://eres.dexignzone.com/xhtml/page-error-404.html");
			
			setCookie('logo_src', 'https://eres.dexignzone.com/xhtml/page-error-404.html');
			setCookie('logo_src2', 'https://eres.dexignzone.com/xhtml/page-error-404.html');
